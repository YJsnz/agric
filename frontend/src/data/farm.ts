import type { DeviceRecord, DockModuleDefinition, FarmZone, IrrigationUnit, SceneEntity } from '@/types'

export const sceneEntities: SceneEntity[] = [
...
export const dockModules: DockModuleDefinition[] = [
...
export const irrigationUnits: IrrigationUnit[] = [
